...
export default function Nav() {
  ...
  return (
    <nav style={{
      ...
      backdropFilter: 'blur(8px)', backgroundColor: 'rgba(250, 247, 242, 0.92)',
    }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '64px' }}>
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none' }}>
          ...
          <span style={{ fontFamily: "'DM Serif Display', serif", fontSize: '1.15rem', color: 'var(--brown)' }}>Barnaglaður</span>
        </Link>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          {!isApp && (
            <Link to="/app/gratur" style={{
              ...
              fontWeight: 500, fontFamily: "'DM Sans', sans-serif", transition: 'opacity 0.2s',
            }}
          ...
          {isApp && (
            <Link to="/" style={{ color: 'var(--brown-light)', textDecoration: 'none', fontSize: '0.9rem', fontFamily: "'DM Sans', sans-serif" }}>
              {t.nav.home}
            </Link>
          )}
  ...
  if (!user) {
    return (
      <button onClick={() => navigate('/app/maelar')} style={{
        ...
        fontFamily: "'DM Sans', sans-serif", transition: 'box-shadow 0.15s',
      }}
...
const dropItem = {
  ...
  color: 'var(--brown)', fontFamily: "'DM Sans', sans-serif", textAlign: 'left',
};
